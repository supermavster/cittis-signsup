...
object EndPoints {
    ...
    const val URL_GET_VERTICAL_INFO_SERVICES = "${URL_GET_IMAGES}informativesigns&from=SI-07"
    const val URL_GET_VERTICAL_INFO_TOURIST = "${URL_GET_IMAGES}touristsigns"
    const val URL_GET_VERTICAL_INFO_LOCATION = "${URL_GET_IMAGES}informativesigns&from=SI-01&to=SI-06"
    const val URL_GET_VERTICAL_REGULATORY = "${URL_GET_IMAGES}regulatorysigns"
    const val URL_GET_VERTICAL_PREVENTIVES = "${URL_GET_IMAGES}preventivesigns"
    const val URL_GET_VERTICAL_WORK = "${URL_GET_IMAGES}worksigns"
